  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/asignup" element={<Ausig handleAuth={handleAuth} />} />
        <Route path="/" element={!auth ? <Ausig handleAuth={handleAuth} /> : <Navigate to="/chat" />} />
        <Route
          path="/chat"
          element={
            !auth ? (
